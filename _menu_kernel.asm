...
STRING_PACHINKO = . - STRING_CONSTANTS
    byte 145, 88, 96, 113, 120, 137, 128, 144, 0
STRING_LADDER = . - STRING_CONSTANTS
    byte 129, 88, 97, 97, 104, 153, 0
STRING_BREAKOUT = . - STRING_CONSTANTS
    byte 89, 153, 104, 88, 128, 144, 168, 161, 0
...
STAGE_NAMES
    ...
    byte STRING_PACHINKO
    byte STRING_LADDER
    byte STRING_BREAKOUT
